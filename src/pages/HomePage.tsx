...
const HomePage = () => {
  return (
    <PageTransition>
      <SEO
        title="Urban Cowboy Rentals | Premium Equipment Rentals"
                  ...
                  <div className="relative overflow-hidden rounded-[2rem] border border-yellow-500/10">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8">
                      ...
                      <p className="mt-4 max-w-lg text-base leading-relaxed text-[#d6c7b8]">
                        Premium rental equipment designed for construction,
                        hauling, demolition, transport, and serious jobsite work.
                      </p>
                    </div>
                  </div>
